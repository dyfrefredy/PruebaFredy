...
export const AV_INPUT_CONTROL_VALUE_ACCESSOR: any = {
  ...
  useExisting: forwardRef(() => AvCommoditiesListComponent),
  multi: true,
};


@Component({
  selector: 'av-commodities-list',
  templateUrl: './av-commodities-list.component.html',
  providers: [AV_INPUT_CONTROL_VALUE_ACCESSOR],
})
export class AvCommoditiesListComponent implements ControlValueAccessor {
